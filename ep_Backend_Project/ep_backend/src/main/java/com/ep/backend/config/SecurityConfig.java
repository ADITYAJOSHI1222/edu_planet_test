...
import com.ep.backend.Security.JwtAuthenticationEntryPoint;
import com.ep.backend.Security.JwtAuthenticationFilter;
...
//	                .logoutUrl("/do-logout");
         ...
         http
	            .csrf()
                 ...
                 .requestMatchers(HttpMethod.POST,"/studentAPI")
                 .permitAll()
